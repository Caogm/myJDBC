...
public class JDBCDemo2 {
	public static void main(String[] args) throws Exception {
		 ...
		 * "jdbc:mysql://localhost:3306/myfirstdb?useSSL=true&serverTimezone=GMT";
		 * String username = "root"; String password = "cgm@51316"; Connection con =
		...
		String sql = "SELECT * FROM userstest WHERE username=? AND PASSWORD=?";
